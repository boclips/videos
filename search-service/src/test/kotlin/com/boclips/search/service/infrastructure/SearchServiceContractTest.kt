...
class SearchServiceContractTest : EmbeddedElasticSearchIntegrationTest() {
    ...
    fun `paginates results`(queryService: GenericSearchService, adminService: GenericSearchServiceAdmin<VideoMetadata>) {
        ...
        val page1 = queryService.search(PaginatedSearchRequest(query = Query("gentleman"), startIndex = 0, windowSize = 2))
        val page2 = queryService.search(PaginatedSearchRequest(query = Query("gentleman"), startIndex = 2, windowSize = 2))
