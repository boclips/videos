...
class LegacyVideoMetadataToSolrInputDocumentConverterTest {
    ...
    fun `description is mapped to the description field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("description").value).isEqualTo(
    ...
    fun `joined keywords are mapped to the keywords field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("keywords").value).isEqualTo(
            "k1, k2"
        )
    }
    ...
    fun `duration is mapped to the duration field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("duration").value).isEqualTo(
            "00:01:40"
        )
    }
    ...
    fun `duration in seconds is mapped to the durationsecs field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("durationsecs").value).isEqualTo(
            950
        )
    }
    ...
    fun `releaseDate in seconds is mapped to the clip_date field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("clip_date").value).isEqualTo(
    ...
    fun `contentPartnerVideoId is mapped to the unique_id field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("unique_id").value).isEqualTo(
            "123"
        )
    }
    ...
    fun `contentPartnerName and contentPartnerVideoId are mapped to the namespace field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("namespace").value).isEqualTo(
            "Ted-Ed:abc"
        )
    }
    ...
    fun `videoType is mapped to the typename field`() {
        ...
        assertThat(LegacyVideoMetadataToSolrInputDocumentConverter.convert(video).getField("typename").value).isEqualTo(
            "TED Talks"
        )
    }
}