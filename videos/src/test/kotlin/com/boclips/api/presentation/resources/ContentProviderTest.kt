...
class ContentProviderTest {
    ...
    fun fromContentProvider_transformsName() {
        val contentProviderResource = ContentProvider.fromContentProvider(com.boclips.api.contentproviders.ContentProvider(name = "name", id = "content-provider-id"), UriComponentsBuilder.newInstance())
