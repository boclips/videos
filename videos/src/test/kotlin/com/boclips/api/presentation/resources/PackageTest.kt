...
class PackageTest {
    ...
    fun fromPackage_transformsName() {
        val packageResource = Package.fromPackage(com.boclips.api.domain.model.Package("package-id", "name"), UriComponentsBuilder.newInstance())
    ...
    fun fromPackage_transformsExcludedContentProviders() {
        val packageResource = Package.fromPackage(com.boclips.api.domain.model.Package("package-id", "name", listOf(ContentProvider(name = "item-1"), ContentProvider(name = "item-2"))), UriComponentsBuilder.newInstance())
