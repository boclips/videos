...
class ContentProviderTest {
    ...
    fun fromContentProvider_transformsName() {
        val contentProviderResource = ContentProvider.fromContentProvider(com.boclips.videos.domain.model.ContentProvider(name = "name", id = "content-provider-id"), UriComponentsBuilder.newInstance())
