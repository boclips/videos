...
@ControllerAdvice(assignableTypes = [LegacyContentPartnerController::class])
class LegacyContentPartnerControllerAdvice(private val projectionResolver: ProjectionResolver) :
