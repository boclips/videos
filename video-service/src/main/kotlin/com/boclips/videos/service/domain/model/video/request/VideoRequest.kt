...
class VideoRequest(
    ...
    val ageRangesRelaxed: List<AgeRange>? = null,
    val ageRangeStrict: AgeRange? = null,
    ...
    fun toQuery(videoAccess: VideoAccess): VideoQuery {
        ...
        return VideoQuery(
            ...
            userQuery = UserQuery(
                ...
                ageRangeStrict = ageRangeStrict?.let { convertAgeRange(ageRangeStrict) },
                ageRangesRelaxed = ageRangesRelaxed?.map { ageRange -> convertAgeRange(ageRange) },
