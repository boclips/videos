...
class RateVideoRequestTest {
    ...
    fun `validates rating being null`() {
        val violations = validator.validate(RateVideoRequest(rating = null, videoId = ""))
    ...
    fun `validates minimum rating`() {
        val violations = validator.validate(RateVideoRequest(rating = -1, videoId = ""))
    ...
    fun `validates maximum rating`() {
        val violations = validator.validate(RateVideoRequest(rating = 6, videoId = ""))
