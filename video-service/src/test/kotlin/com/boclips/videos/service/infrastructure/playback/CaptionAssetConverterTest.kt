...
class CaptionAssetConverterTest {
    ...
    fun `sets language`() {
        ...
        assertThat(getCaptionAsset(createCaptions(language = Locale.forLanguageTag("es-ES"))).language).isEqualTo(KalturaLanguage.SPANISH)
        assertThat(getCaptionAsset(createCaptions(language = Locale.FRENCH)).language).isEqualTo(KalturaLanguage.FRENCH)
        assertThat(getCaptionAsset(createCaptions(language = Locale.forLanguageTag("pl-PL"))).language).isEqualTo(KalturaLanguage.POLISH)
    }
