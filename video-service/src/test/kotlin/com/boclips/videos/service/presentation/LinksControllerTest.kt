        ...
        mockMvc.perform(get("/v1").asTeacher(userId))
            ...
            .andExpect(
                jsonPath(
                    ...
                    containsString("{?query,sort_by,duration,duration_min,duration_max,released_date_from,released_date_to,source,age_range_min,age_range_max,age_range,size,page,subject,subjects_set_manually,promoted,content_partner,type,is_classroom}")
                )
            )
            ...
            .andExpect(
                jsonPath(
                    ...
                    endsWith("collections?public=true{&query,subject,projection,page,size,age_range_min,age_range_max,age_range}")
                )
            )
            .andExpect(
                jsonPath(
                    "$._links.searchCollections.href",
                    endsWith("collections{?query,subject,public,projection,page,size,age_range_min,age_range_max,age_range}")
                )
            )
            .andExpect(
                jsonPath(
            ...
            .andExpect(
                jsonPath(
                    ...
                    endsWith("collections?projection=list&page=0&size=30&owner=teacher@teacher.com&bookmarked=true&sort_by=UPDATE_DATE")
                )
            )
            .andExpect(
                jsonPath(
