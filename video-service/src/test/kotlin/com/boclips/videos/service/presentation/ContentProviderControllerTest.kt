...
import com.boclips.videos.service.domain.services.ContentProviderService
...
class ContentProviderControllerTest {
    ...
    fun getContentProviderService() {
        whenever(contentProviderService.getById("content-provider-id")).thenReturn(Mono.just(com.boclips.videos.service.domain.model.ContentProvider("bla").apply { id = "content-provider-id" }))
