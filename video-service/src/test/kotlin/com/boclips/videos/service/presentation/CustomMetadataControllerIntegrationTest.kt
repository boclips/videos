...
class CustomMetadataControllerIntegrationTest : AbstractSpringIntegrationTest() {
    @Autowired
    lateinit var mockMvc: MockMvc

    @Test
    fun `returns no validation error when file is a valid CSV`() {
    ...
    @Test
    fun `returns meaningful error when video id is invalid`() {
        val csvName = "valid-ids.csv"
        val csvFile = File(csvName)
