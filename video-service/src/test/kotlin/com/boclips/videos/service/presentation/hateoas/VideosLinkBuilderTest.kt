...
class VideosLinkBuilderTest {
    ...
    fun `search link when authenticated`() {
        ...
        assertThat(link.href).isEqualTo("/v1/videos{?query,sort_by,include_tag,exclude_tag,min_duration,max_duration,released_date_from,released_date_to,source,age_range_min,age_range_max,size,page,subject}")
