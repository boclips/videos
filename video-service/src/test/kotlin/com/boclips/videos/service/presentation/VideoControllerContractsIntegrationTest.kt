...
class VideoControllerContractsIntegrationTest : AbstractSpringIntegrationTest() {
    @Autowired
    ...
    inner class VideoSearch {
        ...
        fun `limits search results to contracted IDs`() {
            ...
            createSelectedVideosContract(firstContractedVideo.value, secondContractedVideo.value)
