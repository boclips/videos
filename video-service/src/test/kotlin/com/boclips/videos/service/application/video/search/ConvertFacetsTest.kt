...
class FacetConverterTest {
    ...
    fun `converts duration facets`() {
        val facets = FacetConverter().invoke(ageRangesFacets = null, durationFacets = listOf("PT0S-PT1M"),
            resourcesFacets = null, includeChannelFacets = null, videoTypesFacets = null)
    ...
    fun `converts attachment type facets`() {
        val facets = FacetConverter().invoke(ageRangesFacets = null, durationFacets = null,
            resourcesFacets = listOf("Activity"), includeChannelFacets = null, videoTypesFacets = null)
    ...
    fun `converts video type facets`() {
        val facets = FacetConverter().invoke(ageRangesFacets = null, durationFacets = null, resourcesFacets = null,
            videoTypesFacets = listOf("Stock"), includeChannelFacets = null)
