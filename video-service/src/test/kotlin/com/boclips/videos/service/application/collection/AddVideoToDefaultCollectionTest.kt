...
class AddVideoToDefaultCollectionTest {
    ...
    fun `creates a collection if it doesn't exist`() {
        ...
        verify(collectionService).create("me@me.com")
    }

    @Test
    fun `does not create a collection if it already exist`() {
        collectionService = mock {
            on { getByOwner("me@me.com") } doReturn listOf(createCollection(owner = "me@me.com"))
        }
        ...
        verify(collectionService, Times(0)).create("me@me.com")
    }
}