...
import com.boclips.videos.presentation.resources.ContentProvider
...
class ContentProviderControllerTest {
    ...
    fun getContentProviderService() {
        whenever(contentProviderService.getById("content-provider-id")).thenReturn(Mono.just(com.boclips.videos.domain.model.ContentProvider("bla").apply { id = "content-provider-id" }))
